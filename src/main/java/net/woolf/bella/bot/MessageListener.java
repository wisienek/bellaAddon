...
public class MessageListener extends ListenerAdapter {
	...
	private static final HashSet<String> AllowedGuilds = new HashSet<String>(
			Arrays.asList( "840884051174752256" ) );
	...
	private void handleNarration(
		...
		String warp = event.getOption( "warp" ) != null ? event.getOption( "warp" ).getAsString()
				: null;
		String user = event.getOption( "user" ) != null ? event.getOption( "user" ).getAsString()
				: null;
		Long range = event.getOption( "range" ) != null ? event.getOption( "range" ).getAsLong()
				: 20;
