...
//
//import Types.ArmorEquipEvent;
//import Types.ArmorType;
//import net.woolf.bella.Main;
//import Types.ArmorEquipEvent.EquipMethod;
//
...
//	) {
//		Main.getInstance().logger.info( "INVENTORY CLICK FORM ARMOURLISTENER" );
//
...
//
//		if (
//			e.getSlotType() != SlotType.ARMOR && e.getSlotType() != SlotType.QUICKBAR
...
//		}
//
//		Main.getInstance().logger.info( "INITIAL CHECKS INVENTORY CLICK FORM ARMOURLISTENER" );
//
//		if ( shift ) {
...
//							(Player) e.getWhoClicked(), EquipMethod.SHIFT_CLICK, newArmorType,
...
//								.matchType( !isAirOrNull( e.getCurrentItem() ) ? e.getCurrentItem()
//										: e.getCursor() );
//					}
//				}
//			} else {
...
//		}
//
//		Main.getInstance().logger.info( "FINISH INVENTORY CLICK FORM ARMOURLISTENER" );
//	}
//
...
//				if (
//					e.getClickedBlock() != null && e.getAction() == Action.RIGHT_CLICK_BLOCK
//							&& !player.isSneaking()
...
//							EquipMethod.HOTBAR, ArmorType.matchType( e.getItem() ), null,
//							e.getItem() );
//
//					Bukkit.getServer().getPluginManager().callEvent( armorEquipEvent );
//
...
//
//			ArmorEquipEvent armorEquipEvent = new ArmorEquipEvent( p, EquipMethod.BROKE, type,
...
//				Bukkit.getServer()
//						.getPluginManager()
//						.callEvent( new ArmorEquipEvent( p, EquipMethod.DEATH,
...
//	 */
//	public static boolean isAirOrNull(
//			ItemStack item
//	) {
