...
public class FileReader {
	public static YamlConfiguration getWarpConfig() {
		File configFile = new File( Main.getInstance().getDataFolder() + File.separator + ".." + File.separator + "EasyWarp", "warps.yml" );
	...
	public static Location getWarp(@Nonnull String name) {
		...
		if( name == null || !config.contains("warps." + name) ) return null;
